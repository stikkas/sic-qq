...
Ext.define('qqext.Menu', {
	...
	statics: {
		 ...
		 *
		 * - 0 - меню для формы регистрации запроса ["добавить" "редактировать" "сохранить" "печать" "удалить" "регистрировать"]
		 * - 1 - меню для формы уведомления заявителю ["добавить" "сохранить" "редактировать"]
		 * - 2 - меню для формы передачи на исполнение ["добавить" "редактировать" "сохранить" "удалить" "регистрировать"]
		 * - 3 - меню для формы исполнение запроса ["добавить" "редактировать" "сохранить" "удалить" "регистрировать"]
		 *
