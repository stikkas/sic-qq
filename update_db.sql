...
INSERT INTO "SIC"."CORE_PARAMETER" (PARAMETER_CODE, SUBSYSTEM_NUMBER, PARAMETER_NAME, PARAMETER_DESCRIPTION, PARAMETER_VALUE) VALUES ('DOCUMENT_ROOT', '0', 'Корень файловой системы', 'Относительно него указываются пути к файлам', '/FILES');
